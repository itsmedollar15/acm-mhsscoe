...
const TeamSectionsPostCard = ({ title, level, user }) => {
  return (
    <Glassmorphism className="relative overflow-hidden transition-all duration-500 group rounded-xl hover:shadow-2xl">
      {/* Background Pattern */}
      ...
      <div className="relative flex flex-col p-5">
        ...
        <div className="relative mx-auto mb-4">
          <div className="w-48 h-48 overflow-hidden transition-transform duration-500 shadow-lg rounded-xl group-hover:scale-105">
            <img
          ...
          {/* Level Badge */}
          <div className="absolute p-2 -translate-x-1/2 bg-white border-2 border-blue-100 rounded-full shadow-lg -bottom-2 left-1/2">
        ...
        <div className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-t from-blue-600/10 to-transparent group-hover:opacity-100"></div>
      </div>
    </Glassmorphism>
  );
};
